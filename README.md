...
* Meanwhile we're still waiting for a reliable & safe north-south routes - Van Buren? Jeff & Jack? Maryland? - another bridge between Third Ward & Walker's Point, the list goes on... Though you'd think that a city (MKE) with such an affinity for its sibling Pittsburgh, would take a hint from PBG and get some more dang bridges, but I digress.
